...
import net.zzqd.mmall.common.TokenCache;
import net.zzqd.mmall.dao.UserMapper;
import net.zzqd.mmall.pojo.User;
import net.zzqd.mmall.service.IUserService;
import net.zzqd.mmall.util.MD5Util;
...
public class UserServiceImpl implements IUserService
{
    ...
    {
        //防止横向越权，要校验一下这个用户的密码，一定要指定是这个用户，应为我们会查询一个count（1），如果不能指定id那么结果就是true count>0
    ...
    {
        //username不能更新，email也要进行一个校验
        //校验的email是是已经存在，而且存在email如果相同的话，不能是我们当前的这个用户，
