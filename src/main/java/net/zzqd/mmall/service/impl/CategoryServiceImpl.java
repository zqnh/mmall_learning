...
public class CategoryServiceImpl implements ICategoryService
{
    ...
    public ServerResponse<List<Category>> getChildrenParallelCategory(Integer cateoryId)
    {
        List<Category> categoryList = categoryMapper.selectCategoryChildrenByParentId(cateoryId);
        if(CollectionUtils.isEmpty(categoryList))
        {
            logger.info("未找到当前分页的子分类");
        }
